...
export class ActualiteCategoryController {
    ...
    @ApiOkResponse({
      description: 'The categories of actuality have been successfully retrieved.',
    ...
    async create(@Body() body: CreateActualiteCategoryDto): Promise<ActualiteCategory> {
    ...
    async updateActuality(@Query('id') id: string, @Body() body: CreateActualiteCategoryDto) {
