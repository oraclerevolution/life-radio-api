...
export class ActualiteCategoryService {
    ...
    constructor(
        @InjectRepository(ActualiteCategory) private readonly repository: Repository<ActualiteCategory>,
    ) {}
    ...
    async create(payload: CreateActualiteCategoryDto): Promise<ActualiteCategory> {
    ...
    async updateActuality(id: string, payload: CreateActualiteCategoryDto): Promise<ActualiteCategory> {
